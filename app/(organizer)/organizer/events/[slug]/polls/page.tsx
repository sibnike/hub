...
import { EventPollsPanel } from '@/components/organizer/event-polls-panel'
import Link from 'next/link'

type PageProps = { params: { slug: string } }

export default async function EventPollsPage({ params }: PageProps) {
